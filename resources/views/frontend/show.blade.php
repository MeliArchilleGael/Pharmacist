            ...
            <div class="row">
                <div class="col-md-5 mr-auto">
                    <div class="border text-center">
                        <img src="frontend/images/product_07_large.png" alt="Image" class="img-fluid p-5">
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <p>
                        <del>$95.00</del>
                        <strong class="text-primary h4">$55.00</strong></p>
                    ...
                    <p><a href="cart.html" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Add To Cart</a>
                    </p>
